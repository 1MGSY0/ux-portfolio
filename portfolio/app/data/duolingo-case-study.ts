...
export const learningsProcess = {
  ...
  intro:
    "This project moved from research to ideation, prototyping, and validation with a consistent focus on designing for healthier long-term language learning.",
  takeaways: [
    {
